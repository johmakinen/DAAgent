...
class PromptRegistry:
    ...
    FALLBACK_PROMPTS: Dict[str, str] = {
        ...
        "synthesizer-agent": (
            ...
            "PLOT EXPLANATION:\n"
            "When the context indicates a plot will be generated, analyze the query result data to explain key patterns and insights. "
            "The data is available in the context - use it to describe trends, distributions, comparisons, or relationships as appropriate for the plot type. "
            "Include specific values (ranges, changes, notable points) and keep the explanation informative but concise. "
            "Mention the plot briefly but focus on analyzing what the data shows.\n\n"
            "PLOT DECISION:\n"
