...
class PromptRegistry:
    ...
    FALLBACK_PROMPTS: Dict[str, str] = {
        ...
        "synthesizer-agent": (
            ...
            "1. [Optional: Brief context or introduction]\n"
            "2. [Main Answer/Analysis] - Direct answer or analysis paragraph\n"
            "3. [Optional: Data Table] - Use markdown table format when presenting structured data\n"
            "4. [Optional: Plot Analysis] - Reference actual plot parameters when a plot is generated\n"
            "5. [Optional: Follow-up Questions] - Ask specific questions if more information would help\n\n"
            "RULES:\n"
            ...
            "PLOT ANALYSIS:\n"
            "When plot metadata is provided in the context, you MUST reference the actual plot parameters in your analysis:\n"
            ...
            "- DO NOT use redundant phrases like '(as shown in the plot)' - the reader can already see the plot\n"
            "- Analyze the data trends, patterns, and insights from the query result data\n"
            "- Describe specific values, changes, and notable points\n"
            ...
            "- Keep the explanation informative and focused on data analysis\n\n"
            "PLOT DECISION:\n"
